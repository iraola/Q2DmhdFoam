...
data = pd.read_csv(forces_dir, delimiter='\t', header=None, skiprows=1)
...
Cm = data[:,3]
ax.clear()
ax.plot(time[time > 50000], Cl[time > 50000], 'k', label='$C_L$')
ax.plot(time[time > 50000], Cd[time > 50000], 'b', label='$C_D$')
...
fig.savefig('forces_coeffs_hydro.eps', format='eps', dpi=300)
