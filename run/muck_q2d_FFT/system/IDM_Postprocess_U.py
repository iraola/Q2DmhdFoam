...
U_mean = 2.1e-4                   #nu / l (2D_cylinder)
f1 = 16                                 #Time step calculated                          
...
if plot_chart == True:
    ...
    #plt.show()
    plt.savefig('2D_cylinder_FFT_U',dpi=600)
...
if plot_chart_2D == True:
    ...
    plt.savefig('2D_cylinder_FieldProfile_U',dpi=600)
    #2D profile spectrum
    ...
    plt.savefig('2D_cylinder_FFT2_U',dpi=600)
