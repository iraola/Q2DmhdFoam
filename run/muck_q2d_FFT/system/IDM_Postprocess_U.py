...
U_mean = 2.1e-4                   #nu / l (2D_cyl_hydro)
f1 = 21                                 #Time step calculated                          
...
if plot_chart == True:
    ...
    #plt.show()
    plt.savefig('2D_cyl_hydro_FFT_U',dpi=600)
...
if plot_chart_2D == True:
    ...
    plt.savefig('2D_cyl_hydro_FieldProfile_U',dpi=600)
    #2D profile spectrum
    ...
    plt.savefig('2D_cyl_hydro_FFT2_U',dpi=600)
